...
switch Prop
    ...
    sP1 = interp1(Table.SubCooled.T(IndP1),Table.SubCooled.s(IndP1),Value,'linear','extrap');
    sP2 = interp1(Table.SubCooled.T(IndP2),Table.SubCooled.s(IndP2),Value,'linear','extrap');
    ...
    sP1 = interp1(Table.SubCooled.v(IndP1),Table.SubCooled.s(IndP1),Value,'linear','extrap');
    sP2 = interp1(Table.SubCooled.v(IndP2),Table.SubCooled.s(IndP2),Value,'linear','extrap');
    s = interp1([P1,P2],[sP1,sP2],P,'linear','extrap');
    ...
    sP1 = interp1(Table.SubCooled.u(IndP1),Table.SubCooled.s(IndP1),Value,'linear','extrap');
    sP2 = interp1(Table.SubCooled.u(IndP2),Table.SubCooled.s(IndP2),Value,'linear','extrap');
    s = interp1([P1,P2],[sP1,sP2],P,'linear','extrap');
    ...
    sP1 = interp1(Table.SubCooled.h(IndP1),Table.SubCooled.s(IndP1),Value,'linear','extrap');
    sP2 = interp1(Table.SubCooled.h(IndP2),Table.SubCooled.s(IndP2),Value,'linear','extrap');
    s = interp1([P1,P2],[sP1,sP2],P,'linear','extrap');
    ...
    case 's'
        ...
        TP1 = interp1(Table.SubCooled.s(IndP1),Table.SubCooled.T(IndP1),Value,'linear','extrap');
        TP2 = interp1(Table.SubCooled.s(IndP2),Table.SubCooled.T(IndP2),Value,'linear','extrap');
        T = interp1([P1,P2],[TP1,TP2],P,'linear','extrap');
        
        vP1 = interp1(Table.SubCooled.s(IndP1),Table.SubCooled.v(IndP1),Value,'linear','extrap');
        vP2 = interp1(Table.SubCooled.s(IndP2),Table.SubCooled.v(IndP2),Value,'linear','extrap');
        v = interp1([P1,P2],[vP1,vP2],P,'linear','extrap');
        
        uP1 = interp1(Table.SubCooled.s(IndP1),Table.SubCooled.u(IndP1),Value,'linear','extrap');
        uP2 = interp1(Table.SubCooled.s(IndP2),Table.SubCooled.u(IndP2),Value,'linear','extrap');
        u = interp1([P1,P2],[uP1,uP2],P,'linear','extrap');
        
        hP1 = interp1(Table.SubCooled.s(IndP1),Table.SubCooled.h(IndP1),Value,'linear','extrap');
        hP2 = interp1(Table.SubCooled.s(IndP2),Table.SubCooled.h(IndP2),Value,'linear','extrap');
        h = interp1([P1,P2],[hP1,hP2],P,'linear','extrap');
