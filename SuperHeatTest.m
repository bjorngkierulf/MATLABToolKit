function SuperState = SuperHeatTest(Prop1,Value1,Prop2,Value2,Table)
...
switch Prop1
    case 'T'
        ...
        breakcase = sum(limitArray > Value1) < 1
    case 'P'
...
%if numel(NewTable.T) < 2 %do the alternate method
    ...
    if strcmp(Prop2,'P') %P is sorted to be prop2 here
        ...
        SuperState = breakCaseSuperHeat(PVec,NewTable,PInput,Prop1,Value1,Table,xInput)
